    ...
    <div class="mobile-container">
      <div class="carousel">
        <div class="navbar px-2 bg-dark">
          ...
          <div class="col pe-2">
            <h6 class="color-esensia text-center mb-0 fw-bold">Daftar Akun Baru</h6>
          </div>
        ...
        <form method="POST" action="">
          ...
          <div class="content p-2 d-flex align-items-center">
            <div class="col-9 text-center mx-auto mb-5">
              <a href="<?= base_url('auth/register_google') ?>" class="rounded-15 btn btn-success px-3 mb-3 text-light">
              ...
              <div class="form-group mb-3">
                <div class="d-flex align-items-center">
                  <input type="text" id="inputName" name="name" class="form-control form-control-lg rounded-15" placeholder="Masukkan Nama Lengkap" required="" autofocus="" style="padding-left:35px; font-size: 14px;">
                  <i class="form-icon fe fe-user"></i>
                </div>
                <?= $this->session->flashdata('msg_name') ?>
              </div>
              <div class="form-group mb-3">
                <div class="d-flex align-items-center">
                  <input type="email" id="inputEmail" name="email" class="form-control form-control-lg rounded-15" placeholder="Masukkan Email Anda" required="" style="padding-left:35px; font-size: 14px;">
                  <i class="form-icon fe fe-mail"></i>
                </div>
              ...
              <div class="form-group mb-4">
                <div class="d-flex align-items-center position-relative">
                  <input type="password" name="confirm_password" class="form-control form-control-lg rounded-15" placeholder="Konfirmasi Password" required="" style="padding-left:35px; font-size: 14px;">
                  <i class="form-icon fe fe-key"></i>
                  <a role="button" class="password-show" data-show="0" style="color:#858585;right:5px;">
                    <i class="fe fe-eye-off" aria-hidden="true"></i>
                  </a>
                </div>
                <?= $this->session->flashdata('msg_confirm') ?>
              </div>
              <button class="btn btn-success rounded-15 py-2 px-3 mb-3">Daftar</button>
              <div>
                <span>Sudah punya akun?</span>
                <a href="<?= base_url('auth') ?>" class="fw-bold text-success">Masuk Disini</a>
              </div>
            </div>
          </div>
