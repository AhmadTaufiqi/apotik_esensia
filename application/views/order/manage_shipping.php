    ...
    <div class="row">
      ...
      <div class="col-lg-4 mb-4">
            ...
            <form method="post" action="<?= base_url('admin_orders/manage_shipping/' . $order['order_id']) ?>">
              <div class="mb-3">
                ...
                <select class="form-select" id="shipping_status" name="shipping_status" required>
                  ...
                  <option value="" <?= (!isset($order['shipping_status']) || empty($order['shipping_status'])) ? 'selected' : '' ?>>
                    Belum dikirim
                  </option>
                  <option value="sending" <?= (isset($order['shipping_status']) && $order['shipping_status'] == 'sending') ? 'selected' : '' ?>>
                    Sedang dikirim
                  </option>
                  <option value="arrived" <?= (isset($order['shipping_status']) && $order['shipping_status'] == 'arrived') ? 'selected' : '' ?>>
                    Sudah sampai
                  </option>
                </select>
                <div class="form-text">
        ...
        <div class="card shadow-sm mt-3">
          ...
          <div class="card-body">
            <div class="mb-2">
              <span class="badge bg-secondary me-2">Belum dikirim</span>
              <small class="text-muted">Pesanan belum diproses untuk pengiriman</small>
            </div>
            <div class="mb-2">
