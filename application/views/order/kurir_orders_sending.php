<main role="main" class="main-content" style="margin-top: 64px;">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="btn-action">
      ...
      <a href="<?= base_url('kurir_orders/setShippedOrder/' . $order['id']) ?>" class="btn btn-success text-light">
        <i class="fas fa-check me-2"></i>Selesai Pengiriman
      </a>
    </div>
  </div>
  ...
  <div class="card mb-3">
    <div class="card-header bg-primary text-white">
      <h5 class="mb-0 text-light"><i class="fas fa-shopping-cart me-2"></i>Detail Pengiriman</h5>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
          <table class="table table-borderless">
            ...
            <tr>
              <td width="40%" class="fw-bold">No. Telepon</td>
              <td width="5%">:</td>
              <td><?= $order['customer_phone'] ?? '-' ?></td>
            </tr>
            <tr>
              <td width="40%" class="fw-bold">Total Harga</td>
              <td width="5%">:</td>
        ...
        <div class="col-md-6">
          <table class="table table-borderless">
            <tr>
              <td width="40%" class="fw-bold">Alamat</td>
              <td width="5%">:</td>
              <td>
            ...
            <tr>
              <td class="fw-bold">Chat WhatsApp</td>
              <td>:</td>
              <td>
