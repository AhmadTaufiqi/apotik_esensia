    <section id="footer">
      <div class="d-flex p-2 mb-2">
        <div class="col text-end pe-2">
          <span class="h2" style="letter-spacing: 5px;">KLINIK ESENSIA</span>
        </div>
        <div class="border-right">
        </div>
        <div class="col ps-2">
          <span class="small">Jl. Wolter Monginsidi No.40, Pedurungan, Kota Semarang</span><br>
          <span class="small"> Jawa Tengah 50192</span>
        </div>
      </div>
    ...
    <script src="<?= base_url() ?>dist/uuid/esm-browser/v4.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/4.2.0/crypto-js.min.js" integrity="sha512-a+SUDuwNzXDvz4XrIcXHuCf089/iJAoN4lmrXJg18XnduKK6YlDHNRalv4yd1N40OKI80tFidF+rqTFKGPoWFQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>

    <script src="<?= base_url() ?>dist/js/generate_payment_url.js"></script>
    <script src="<?= base_url() ?>dist/"></script>
    ...
    <?php
    $customer_is_login = 0;
    if (!empty($this->session->userdata('id_akun') && $this->session->userdata('role') == 2)) {
      $customer_is_login = 1;
    }
    ?>
    <script>
