      ...
      <?php if (!empty($product)) : ?>
        ...
        <div class="mb-3">
          <div class="card p-0 rounded-4 overflow-hidden">
            <img src="<?= base_url('dist/img/uploads/products/' . ($product->image ?? 'default_image.png')) ?>" alt="<?= htmlspecialchars($product->name ?? '') ?>" class="w-100 detail-image-product">
          </div>
        </div>
          ...
          <?php if (!empty($product->category)) : ?>
            <div class="mb-3">
              ...
              <div class="d-flex flex-wrap gap-2">
                <span class="badge bg-light text-dark"><?= $category['category'] ?></span>
              </div>
            </div>
          <?php endif; ?>
